(function () {
    ...
    function updateColorsRed(checkbox, tableId, ellipseIds, numbId) {
    ...
    function updateColorsBlack(checkbox, tableId, ellipseIds, numbId) {
        const table = document.getElementById(tableId);
        const numb_t = document.getElementById(numbId);
        // Устанавливаем цвет в зависимости от состояния чекбокса
    ...
    function updateColorsBlackTen(checkbox, tableId, ellipseIds, numbId) {
        const table = document.getElementById(tableId);
        const numb_t = document.getElementById(numbId);
        // Устанавливаем цвет в зависимости от состояния чекбокса
        ...
        const fillColor = checkbox.checked ? '#1F1E1E' : '';  // черный и нет цвета
        const numbColor = checkbox.checked ? '#FFFFFF' : '#1F1E1E';  // белый и черный
        // Устанавливаем для таблицы и эллипсов
    ...
    // -------- Функция для не активного стола
    function updateColorsGray(checkbox, tableId, ellipseIds) {
        const table = document.getElementById(tableId);
        // Устанавливаем для таблицы и эллипсов
        table.setAttribute('fill', '#bfbfbf');
        table.setAttribute('stroke', '#bfbfbf');
        ellipseIds.forEach(id => {
            document.getElementById(id).setAttribute('fill', '#bfbfbf');
            document.getElementById(id).setAttribute('stroke', '#bfbfbf');
        });
    }

    //-------- Функция считает кол-во билетов и сумму
    ...
    updateColorsGray(checkboxT5, 'table5',
            ['ellipse_t5_1', 'ellipse_t5_2', 'ellipse_t5_3', 'ellipse_t5_4', 'ellipse_t5_5', 'ellipse_t5_6', 'ellipse_t5_7']
            );

    // Добавляем обработчики событий для чекбоксов
    checkboxT1.addEventListener('change', function () {
        updateColorsRed(checkboxT1,
            'table1',
            ['ellipse_t1_1', 'ellipse_t1_2', 'ellipse_t1_3', 'ellipse_t1_4', 'ellipse_t1_5'],
            't1');
        updateTicketCount();  // Вызов второй функции
    });
    checkboxT2.addEventListener('change', function () {
        updateColorsBlack(checkboxT2,
            'table2',
            ['ellipse_t2_1', 'ellipse_t2_2', 'ellipse_t2_3', 'ellipse_t2_4', 'ellipse_t2_5', 'ellipse_t2_6', 'ellipse_t2_7'],
            't2');
        updateTicketCount();
    });
        checkboxT3.addEventListener('change', function () {
        updateColorsBlack(checkboxT3,
            'table3',
            ['ellipse_t3_1', 'ellipse_t3_2', 'ellipse_t3_3', 'ellipse_t3_4', 'ellipse_t3_5', 'ellipse_t3_6', 'ellipse_t3_7'],
            't3');
        updateTicketCount();
    });
    checkboxT4.addEventListener('change', function () {
        updateColorsRed(checkboxT4,
            'table4',
            ['ellipse_t4_1', 'ellipse_t4_2', 'ellipse_t4_3', 'ellipse_t4_4', 'ellipse_t4_5'],
            't4');
        updateTicketCount();
    });
    // checkboxT5.addEventListener('change', function () {
    //     updateColorsBlack(checkboxT5,
    //         'table5',
    //         ['ellipse_t5_1', 'ellipse_t5_2', 'ellipse_t5_3', 'ellipse_t5_4', 'ellipse_t5_5', 'ellipse_t5_6', 'ellipse_t5_7'],
    //         't5');
    //     updateTicketCount();
    // });
    checkboxT6.addEventListener('change', function () {
        updateColorsBlack(checkboxT6,
            'table6',
            ['ellipse_t6_1', 'ellipse_t6_2', 'ellipse_t6_3', 'ellipse_t6_4', 'ellipse_t6_5', 'ellipse_t6_6', 'ellipse_t6_7'],
            't6');
        updateTicketCount();
    });
    checkboxT7.addEventListener('change', function () {
        updateColorsRed(checkboxT7,
            'table7',
            ['ellipse_t7_1', 'ellipse_t7_2', 'ellipse_t7_3', 'ellipse_t7_4'],
            't7');
        updateTicketCount();
    });
    checkboxT8.addEventListener('change', function () {
        updateColorsRed(checkboxT8,
            'table8',
            ['ellipse_t8_1', 'ellipse_t8_2', 'ellipse_t8_3'],
            't8');
        updateTicketCount();
    });
    checkboxT9.addEventListener('change', function () {
        updateColorsRed(checkboxT9,
            'table9',
            ['ellipse_t9_1', 'ellipse_t9_2', 'ellipse_t9_3'],
            't9');
        updateTicketCount();
    });
    checkboxT10.addEventListener('change', function () {
        updateColorsBlackTen(checkboxT10,
            'table10',
            ['ellipse_t10_1', 'ellipse_t10_2', 'ellipse_t10_3', 'ellipse_t10_4'],
            't10');
        updateTicketCount();
    });
    checkboxT11.addEventListener('change', function () {
        updateColorsBlack(checkboxT11, 'table11',
            ['ellipse_t11_1', 'ellipse_t11_2', 'ellipse_t11_3', 'ellipse_t11_4', 'ellipse_t11_5', 'ellipse_t11_6', 'ellipse_t11_7'],
            't11');
        updateTicketCount();
    });
